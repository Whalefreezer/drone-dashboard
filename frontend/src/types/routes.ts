...
export const RACE_JSON = (eventId: string, raceId: string) => `${EVENTS_ROOT}/${eventId}/${raceId}/Race.json`;
export const RESULT_JSON = (eventId: string, raceId: string) => `${EVENTS_ROOT}/${eventId}/${raceId}/Result.json`;
